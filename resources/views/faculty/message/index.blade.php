            ...
            <div class="app-inner-layout__top-pane">
                ...
                <span class="opacity-7 mr-1">
                    <i class="fa fa-cog"></i>
                        ...
                        <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu dropdown-menu-right" x-placement="bottom-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(110px, 32px, 0px);">
